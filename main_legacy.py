...
app = FastAPI(title="LongCat-2.0 ↔ Xcode 26+ bridge")
...
async def list_models():
    ...
    return {
        "object": "list",
        "data": [
            {"id": MODEL_NAME, "object": "model", "owned_by": "longcat"}
        ],
    }
...
async def stream_aggregator(body: dict):
            ...
            async with client.stream(
                ...
                async for line in resp.aiter_lines():
                    ...
                    if delta := choice.get("delta"):
                        ...
                        # Process reasoning content for LongCat-2.0
    ...
    if body.get("model") == MODEL_NAME and SHOW_THINKING and reasoning_content:
    ...
    single_chunk = {
        ...
        "model": model_name or body.get("model") or MODEL_NAME,
        "choices": [
            {
                "index": 0,
...
async def chat_completions(request: Request):
    """
    Proxies the request to LongCat-2.0, always requesting a stream.
